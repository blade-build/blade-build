...
请下载[最新稳定版](https://github.com/blade-build/blade-build/releases/latest)；`master` 分支是 Blade 3 的开发主线。完整列表见 [Releases](https://github.com/blade-build/blade-build/releases)，升级细节请参考[升级到 V3 版](doc/zh_CN/upgrade-to-v3.md)。
