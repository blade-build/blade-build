...
- [How custom rules (`define_rule`) work](develop/custom_rule.md)
- [How C/C++ programs are built](develop/cc_build.md)
- [How the C/C++ header dependency check (hdrs check) works](develop/hdrs_check.md)
- [How the static undefined-symbol check (`check_undefined`) works](develop/check_undefined.md)
- [How `export_map` (symbol-export control) works](develop/export_map.md)
- [How vcpkg support works](develop/vcpkg.md)
